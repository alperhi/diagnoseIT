...
import static org.diagnoseit.engine.rule.annotation.TagValue.InjectionStrategy.BY_VALUE;
...
/**
 * FieldInjection implementation to inject {@link Tag}s, respectively the value
 * of a {@link Tag}.
 *
...
public class TagInjection extends FieldInjection {
	...
	public Object determineValueToInject(ExecutionContext context) {
		...
		for (Tag tag : context.getRuleInput().getUnraveled()) {
			if (tag.getType().equals(getType())) {
				return getInjectionStrategy().equals(BY_VALUE) ? tag.getValue()
						: tag;
			}
		}
	...
	public String toString() {
		return "TagInjection [type=" + type + ", injectionStrategy="
				+ injectionStrategy + ", getInjectee()=" + getInjectee() + "]";
	}
	...
	public boolean equals(Object o) {
		...
		return new EqualsBuilder().appendSuper(super.equals(o))
				...
				.append(getInjectionStrategy(), that.getInjectionStrategy())
				.isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(17, 37).appendSuper(super.hashCode())
				.append(getType()).append(getInjectionStrategy()).toHashCode();
	}
}
