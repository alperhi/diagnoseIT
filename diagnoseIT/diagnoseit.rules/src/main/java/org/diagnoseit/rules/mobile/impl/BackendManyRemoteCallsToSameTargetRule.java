...
//
/// **
// * Rule analyzes if the backend executed too many equal remote calls to the same device that
// becomes
// * a bottleneck.
// *
// * @author Alper Hi
...
public class BackendManyRemoteCallsToSameTargetRule {
	...
	// LoggerInitializer.getLogger(BackendManyRemoteCallsToSameTargetRule.class.getName());
	//
	// private static final double REMOTE_CALLS_PERCENT =
	// AntiPatternConfig.getInstance().getPropertyDouble("BACKEND_MANY_EQUAL_REMOTE_CALLS_RULE_REMOTE_CALLS_PERCENT");
	//
	// private static final double DURATION_PERCENT =
	// AntiPatternConfig.getInstance().getPropertyDouble("BACKEND_MANY_EQUAL_REMOTE_CALLS_RULE_DURATION_PERCENT");
	//
	// private static final int MIN_AMOUNT_OF_CALLS =
	// AntiPatternConfig.getInstance().getPropertyInt("BACKEND_MANY_EQUAL_REMOTE_CALLS_RULE_MIN_AMOUNT_OF_CALLS");
	//
	...
	//
	// if (remoteInvocations.isEmpty() || (remoteInvocations.size() < (DURATION_PERCENT *
	...
	// if ((amountEqualRemoteInvos >= MIN_AMOUNT_OF_CALLS) && (amountEqualRemoteInvos >
	// (remoteInvocations.size() * REMOTE_CALLS_PERCENT))) {
	// log.info("Java application executed too many remote calls to the same target. The amount of the
	// calls is " + amountEqualRemoteInvos + ". Total time of the Java agent traces is: "
