 ...
 *
 */
@Rule(name = "MobileAppManyRemoteCallsRule")
public class MobileAppManyRemoteCallsRule {

	private static final Logger log = LoggerInitializer.getLogger(MobileAppManyRemoteCallsRule.class.getName());
