...
public class BackendManyCallsToSameURLRule {
	...
	// LoggerInitializer.getLogger(BackendManyCallsToSameURLRule.class.getName());
	//
	// private static final double URL_CALLS_PERCENT =
	// AntiPatternConfig.getInstance().getPropertyDouble("BACKEND_MANY_EQUAL_URL_CALLS_RULE_URL_CALLS_PERCENT");
	//
	// private static final double DURATION_PERCENT =
	// AntiPatternConfig.getInstance().getPropertyDouble("BACKEND_MANY_EQUAL_URL_CALLS_RULE_DURATION_PERCENT");
	//
	// private static final int MIN_AMOUNT_OF_CALLS =
	// AntiPatternConfig.getInstance().getPropertyInt("BACKEND_MANY_EQUAL_URL_CALLS_RULE_MIN_AMOUNT_OF_CALLS");
	//
	...
	//
	// if (remoteSubtraces.isEmpty() || (remoteSubtraces.size() < (DURATION_PERCENT *
	...
	// if ((amountEqualURLCalls >= MIN_AMOUNT_OF_CALLS) && (amountEqualURLCalls >
	// (remoteSubtraces.size() * URL_CALLS_PERCENT))) {
	// log.info("Java application executed too many calls to the same URL " + key + ". The amount of the
	// calls is " + amountEqualURLCalls + ". Total time of the Java agent traces is: "
